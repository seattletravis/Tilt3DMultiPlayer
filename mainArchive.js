...
// function rotate90(block){
//   if (alternateRotation == false){
//     block.rotation.y = Math.PI
//     alternate = true
//   } else if (alternateRotation == true){
